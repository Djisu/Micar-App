...
namespace MiCar
{
    public partial class frmDailyMileageReadingReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            varPageName = "Daily Mileage Reading Report";
            //**********************************************************
            // Create the Command.
        ...
        {
            clsDailyMileageReadingReport DB = new clsDailyMileageReadingReport();
            ...
            try
            {
                ...
                if (varResponse == true)
                {
                    Response.Redirect("frmDisplayDailyMileageReadingReport.aspx");
                }
                else
                {
