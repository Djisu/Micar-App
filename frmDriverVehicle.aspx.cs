...
namespace MiCar
{
    public partial class frmDriverVehicle : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            varPageName = "Assign Driver to Vehicle";
            //**********************************************************
            // Create the Command.
        ...
        {
            clsDriverVehicle DB = new clsDriverVehicle();
            ...
            try
            {
                ...
                if (cboStartDate.Text == null)
                {
                    lblResults.Text = "Please select the start date";
                    return;
                }
                if (cboEndDate.Text == null)
                {
                    lblResults.Text = "Please select the end date";
                    return;
                }
                string varResponse = DB.Add_rec(cboRegNo.Text, cboDriverNo.Text, DateTime.Parse(cboStartDate.Text), DateTime.Parse(cboEndDate.Text));
                // Fill the DataSet.
                DataSet ds = new DataSet();
                ds = DB.FindTable();
