...
namespace MiCar
{
    public partial class frmFuelRequisitionReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            varPageName = "Fuel Requisitions Report";
            //**********************************************************
            // Create the Command.
        ...
        {
            clsFuelRequisitionReport DB = new clsFuelRequisitionReport();
            ...
            try
            {
                ...
                bool varResponse = DB.Find_rec(cboRegNo1.Text, cboRegNo2.Text, cboDate1.Text, cboDate2.Text);
                if (varResponse == true)
                {
                    Response.Redirect("frmDisplayFuelRequisitionReport.aspx");
                }
                else
                {
