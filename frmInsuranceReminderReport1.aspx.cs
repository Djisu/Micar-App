...
namespace MiCar
{
    public partial class frmInsuranceReminderReport1 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                varPageName = "Insurance Reminder Report";
                //**********************************************************
                // Create the Command.
        ...
        {
            clsInsuranceReminderReport DB = new clsInsuranceReminderReport();
            ...
            try
            {
                ...
                if (varResponse == true)
                {
                    Response.Redirect("frmDisplayInsuranceReminderReport.aspx");
                }
                else
                {
