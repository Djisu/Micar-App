...
namespace MiCar
{
    public partial class frmLogRetentionPeriod1 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                varPageName = "Setup Retention Period";
                //**********************************************************
                // Create the Command.
        ...
        protected void cmdReport_Click(object sender, EventArgs e)
        {
            ...
            string varResponse = DB.AddRetentionPeriod(DateTime.Parse(cboStartDate.Text), DateTime.Parse(cboEndDate.Text), txtUserLabel.Text);
