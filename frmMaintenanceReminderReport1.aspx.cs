...
namespace MiCar
{
    public partial class frmMaintenanceReminderReport1 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                varPageName1 = "Planned Maintenance Report";
                //**********************************************************
                // Create the Command.
        ...
        protected void cmdReport_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (varResponse == true)
                {
                    Response.Redirect("frmDisplayMaintenanceReminderReport.aspx");
                }
                else
                {
