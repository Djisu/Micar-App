...
namespace MiCar
{
    public partial class frmRoadWorthyReminderReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            varPageName = "Roadworthy Reminder Report";
            //**********************************************************
            // Create the Command.
        ...
        {
            clsRoadWorthyReminderReport DB = new clsRoadWorthyReminderReport();
            ...
            try
            {
                ...
                bool varResponse = DB.Find_rec(cboRegNo1.Text, cboRegNo2.Text);
                if (varResponse == true)
                {
                    Response.Redirect("frmDisplayRoadWorthyReminderReport.aspx");
                }
                else
                {
