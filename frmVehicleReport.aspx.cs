...
namespace MiCar
{
    public partial class frmVehicleReport : System.Web.UI.Page
    {
        ...
        {
            clsVehiclesReport DB = new clsVehiclesReport();
            ...
            try
            {
                ...
                if (varResponse == true)
                {
                    Response.Redirect("frmDisplayVehiclesReport.aspx");
                }
                else
                {
